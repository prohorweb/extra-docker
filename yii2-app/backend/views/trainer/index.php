...
<div class="content-box clearfix">
    ...
    <div class="title-box clearfix">
        ...
        <a href="<?= Url::to(['options-create']) ?>" class="btn btn--grey">Параметры</a>
    </div>
    <div class="wrapper">
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($model) {
                        $titles = [];
                        foreach ($model->trainerOptions as $trainerOption) {
                            $titles[] = $trainerOption->option->title;
                        }
...
$this->registerJs(<<<JS
    jQuery('td').click(function (e) {
        ...
        if(e.target == this && id != undefined)
            location.href = '/admin/trainer/update?id=' + id;
    });
JS
);
