...
$_SESSION['referrer'] = strpos(Yii::$app->request->referrer, 'page') !== false ? Yii::$app->request->referrer : (isset($_SESSION['referrer']) && strpos($_SESSION['referrer'], 'history') !== false ? $_SESSION['referrer'] : Url::to(['/history']));
