...
/* @var $model \common\models\ClubCardsParams */
...
$this->title = 'Параметры абонементы';
...
<div class="content-box clearfix">
    ...
    <div class="title-box clearfix">
        ...
        <a href="<?= Url::to(['/club-cards']) ?>" class="btn btn--grey"><i class="flaticon-left-arrow"></i>Назад</a>
    </div>
    <div class="wrapper">
        ...
        <div class="input-row">
            <?= $form->field($model, 'gift_text', ['labelOptions' => ['class' => 'input-label']])->widget(CKEditor::className(), [
                'options' => ['rows' => 6],
                'preset' => 'custom',
                'clientOptions' => [
                    'extraPlugins' => 'justify',
