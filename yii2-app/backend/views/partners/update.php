...
$this->title = 'Партнеры: обновить материал';

$_SESSION['referrer'] = strpos(Yii::$app->request->referrer, 'page') !== false ? Yii::$app->request->referrer : (isset($_SESSION['referrer']) && strpos($_SESSION['referrer'], 'partners') !== false ? $_SESSION['referrer'] : Url::to(['/partners']));
...
<div class="content-box clearfix">
    ...
    <div class="wrapper">
        ...
        <?= $this->render('_metro', [
            ...
            'metro' => new \common\models\MetroPartners()
        ]) ?>
