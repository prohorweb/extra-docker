    ...
    <div class="container">
        ...
        <div class="card-choice__services">
            ...
            <div class="card-choice__services__item">
                ...
                <p><?= $_SESSION["_language"] == "db2" || $_SESSION["_language"] == "db3" ? 'Финская' : 'Турецкая парная' ?>,<br> неограничено</p>
            </div>
        ...
        <div class="card-choice__cards">
            ...
            <div class="popup-wrap" id="card-popup<?= $key ?>">
                ...
                <div class="popup popup--form">
                    ...
                    <?php $form = ActiveForm::begin(['id' => 'callback_' . $key, 'action' => Url::to(['/club/subscribe3/']), 'options' => ['onsubmit' => ($_SESSION["_language"] == "db2" ? "gtag('event', 'zayavka', {'event_category': 'form'});" : "") . "ym(21525628, 'reachGoal', 'zayavka');  dataLayer.push({'event': 'zayavka'});", 'class' => 'popup__form callback2']]) ?>
            ...
            <div class="popup-wrap" id="buy-popup<?= $key ?>">
                ...
                <div class="popup popup--form">
                    ...
                    <?php $form = ActiveForm::begin(['id' => 'callback_' . $key, 'action' => Url::to(['/type/buy/', 'id' => $model->id]), 'options' => ['onsubmit' => ($_SESSION["_language"] == "db2" ? "gtag('event', 'zayavka', {'event_category': 'form'});" : "") . "ym(21525628, 'reachGoal', 'zayavka');  dataLayer.push({'event': 'zayavka'});", 'class' => 'popup__form callback2']]) ?>
                    <div class="form-section__row row">
                        <div class="form-section__item col-12 input-row">
