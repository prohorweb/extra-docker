    ...
    <div class="container">
      <div class="row text-center">
        <div class="col-lg-4 col-md-6"> 
          <a class="card" href="http://piter.<?=$url?>"><img class="card-img-top" src="/img/clubs/welcom-block-img-2.jpg" alt="...">
        ...
        <div class="col-lg-4 col-md-6">
          <a class="card" href="http://iyun.<?=$url?>"><img class="card-img-top" src="/img/clubs/welcom-block-img-1.jpg" alt="...">
            <div class="card-body p-0">
              <div class="d-flex">
                <div class="w-100 py-2">
        ...
        <div class="col-lg-4 col-md-6"> 
          <a class="card" href="http://polyus.<?=$url?>"><img class="card-img-top" src="/img/clubs/welcom-block-img-3.jpg" alt="...">
            <div class="card-body p-0">
              <div class="d-flex">
                <div class="w-100 py-2">
        ...
        <div class="col-lg-6 col-md-6"> 
          <a class="card" href="http://matros.<?=$url?>"><img class="card-img-top" src="/img/clubs/welcom-block-img-4.jpg" alt="...">
            <div class="card-body p-0">
              <div class="d-flex">
                <div class="w-100 py-2">
        ...
        <div class="col-lg-6 col-md-12"> 
          <a class="card" href="http://de-vision.ru"><img class="card-img-top" src="/img/clubs/welcom-block-img-5.jpg" alt="...">
            <div class="card-body p-0">
              <div class="d-flex">
                <div class="w-100 py-2">
            ...
            <div class="row">
              <div class="col-lg-6 text-center">
                <ul class="map-section__list p-0">
                  ...
                  <li><a href="http://iyun.<?=$url?>">ТРЦ «Июнь»</a></li>
                  <li><a href="http://polyus.<?=$url?>">ТРЦ «Южный полюс»</a></li>
                </ul>
              </div>
              <div class="col-lg-6 text-center">
                <ul class="map-section__list p-0">
    ...
    <div class="footer-bottom col-lg-12">
      <div class="container">
        <div class="row">
          ...
          <a class="text-decoration-none" href="http://piter.<?= $url ?>/legal/" target="_blunk">Правовая информация</a></div>
        </div>
      </div>
    </div>
  </footer>
