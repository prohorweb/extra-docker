...
# Class: \YooKassa\Model\Confirmation\ConfirmationEmbedded
...
| ----------:| ---- | ---- | ------- |
| public | [$confirmationToken](../classes/YooKassa-Model-Confirmation-ConfirmationEmbedded.md#property_confirmationToken) |  | Токен для checkout.js |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](../classes/YooKassa-Model-Confirmation-ConfirmationEmbedded.md#method___construct) |  |  |
...
| public | [getConfirmationToken()](../classes/YooKassa-Model-Confirmation-ConfirmationEmbedded.md#method_getConfirmationToken) |  |  |
...
| public | [setConfirmationToken()](../classes/YooKassa-Model-Confirmation-ConfirmationEmbedded.md#method_setConfirmationToken) |  |  |
...
---
### Details
* File: [lib/Model/Confirmation/ConfirmationEmbedded.php](../../lib/Model/Confirmation/ConfirmationEmbedded.php)
* Package: Default
* Class Hierarchy:  
  ...
  * \YooKassa\Model\Confirmation\ConfirmationEmbedded
...
**Details:**
* Inherited From: [\YooKassa\Model\Confirmation\ConfirmationEmbedded](../classes/YooKassa-Model-Confirmation-ConfirmationEmbedded.md)
...
#### public setConfirmationToken() : mixed

```php
public setConfirmationToken(string $confirmationToken) : mixed
```
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code lang="php">string</code> | confirmationToken  |  |
