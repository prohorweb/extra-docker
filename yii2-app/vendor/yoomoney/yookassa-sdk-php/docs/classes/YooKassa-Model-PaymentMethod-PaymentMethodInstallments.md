...
# Class: \YooKassa\Model\PaymentMethod\PaymentMethodInstallments
### Namespace: [\YooKassa\Model\PaymentMethod](../namespaces/yookassa-model-paymentmethod.md)
---
**Summary:**

Класс, описывающий метод оплаты при оплате по частям
...
| public | [$type](../classes/YooKassa-Model-PaymentMethod-PaymentMethodInstallments.md#property_type) |  | Тип объекта |

---
### Methods
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](../classes/YooKassa-Model-PaymentMethod-PaymentMethodInstallments.md#method___construct) |  |  |
...
---
### Details
* File: [lib/Model/PaymentMethod/PaymentMethodInstallments.php](../../lib/Model/PaymentMethod/PaymentMethodInstallments.php)
* Package: Default
* Class Hierarchy:  
  ...
  * \YooKassa\Model\PaymentMethod\PaymentMethodInstallments
...
**Details:**
* Inherited From: [\YooKassa\Model\PaymentMethod\PaymentMethodInstallments](../classes/YooKassa-Model-PaymentMethod-PaymentMethodInstallments.md)
